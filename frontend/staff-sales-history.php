...
<head>
    ...
    <title>My Sales History - Protein Planet</title>
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            <div>
                <h1 style="color: #2C3E50; font-size: 32px; margin-bottom: 5px;">📊 My Sales History</h1>
                <p style="color: #7F8C8D;">Track your sales and performance</p>
            </div>
        </div>
    ...
    <script>
        ...
        async function loadSales() {
            try {
                // Wait for auth to set currentStaff
                ...
                // Get only sales by this staff member
                const snapshot = await firebaseDb.collection('sales')
                    .where('soldBy', '==', window.currentStaff.uid)
                    .orderBy('soldAt', 'desc')
                    .get();
